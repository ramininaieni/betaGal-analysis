...
1. For **experimenter**, give your initials. Please always use the same initials as you use for strain names.
...
```{r}
fileName <- "myData/RAN 7-24-18 BETA GAL RAN11, RAN12, RAN13.xlsx" #Enter your Excel file here. Remember that tab completion will help you get the path & name correct
